...
@Component({
  selector: 'app-supp-commentaire',
  templateUrl: './supp-commentaire.component.html',
  styleUrls: ['./supp-commentaire.component.css'],
  animations: [
...
export class SuppCommentaireComponent {
...
confirm() {
  console.log("Confirm clicked, ID:", this.statutId); 
